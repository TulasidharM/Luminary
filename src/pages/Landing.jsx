...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-indigo-50 to-violet-100 dark:from-slate-900 dark:to-indigo-950 transition-colors duration-500 relative overflow-hidden">
